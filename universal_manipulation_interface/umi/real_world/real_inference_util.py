...
def get_real_umi_action(
    ...
    for robot_idx in range(n_robots):
        ...
        # print("ROBOT _eef_rot_axis_angle: ", env_obs[f'robot{robot_idx}_eef_rot_axis_angle'][-1])
        # print("ROBOT EEF POSE: ", env_obs[f'robot{robot_idx}_eef_pos'][-1])
        start = robot_idx * 10
        ...
        rel_action_pose = mat_to_pose(action_pose_mat)
        # print("REL POSE MAT: ",rel_action_pose)
