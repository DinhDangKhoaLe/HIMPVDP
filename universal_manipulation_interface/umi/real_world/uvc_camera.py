...
from umi.common.cv_util import custom_plot, custom_seg
    ...
    def run(self):
        ...
        try:
            ...
            while not self.stop_event.is_set():
                ...
                # frame = custom_plot(frame, results, self.yolo_model, self.pick_object)

                # add Yolo Segmentation
                # results = self.yolo_model.predict(frame,conf=0.30,task='segment',verbose=False)
                # frame = custom_seg(frame, results, self.yolo_model, self.pick_object)
